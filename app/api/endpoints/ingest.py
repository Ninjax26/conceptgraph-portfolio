...
async def list_courses(
    ...
    return [
        CourseSummaryResponse(
            ...
            graph_sections_total=summary.graph_sections_total,
            graph_sections_succeeded=summary.graph_sections_succeeded,
            graph_batches_failed=summary.graph_batches_failed,
